...
public class MethodTest { // Java 파일은 class 구조체로서 Method로 구성
	...
	public static void main(String[] args) { // 메서드 클래스의 모듈
	...
	// 메서드 정의
	public static int f(int x) { // int:반환타입, f:이름 int, x:매개변수
		int y = 2 * x + 3;		 // ㄴ매개변수 x, 메서드를 호출할 때 x 값 대입
		return y; // 메서드의 return 값의 타입을 메서드 이름앞에 선언
	}
	
	// 메서드 정의 (메서드 안에 메서드를 정의할 순 없다.)
